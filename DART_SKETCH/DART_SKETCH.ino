...
#define capacitivesensor_active 2    // 1 = enabled // 0 = disabled // 2 = EXTERNAL TOUCH IC on pin 7 -9 // 2 = EXTERNAL TOUCH IC on pin 7 - 8 --- CAPACITIVE SENSORS_
...
#define Matrix_Pads 1                // 1 = enabled // 2 = pads on 17-32 circuitposition // 0 = disabled // max7219 chips
...
#define fader_type 0                 // 0 = normal // 1 =  scratch style fader
